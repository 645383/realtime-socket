  ...
  if window.realtime.enabled
    addMessage = (message) ->
      ...
      if list.data('userid').toString() == message.userId.toString()
        list.append "<div class='my-message'><p style='font-size: 15px;'>" + message.msg + "</p></div>"
        list.closest('.form').find('.form-control').val ''
      else
        list.append "<div class='your-message'><p style='font-size: 15px;'>" + message.msg + "</p><footer style='width: 230px;'><cite class='text-muted' title='Someone awesome'>" + message.userName + "</cite></footer></div>"
